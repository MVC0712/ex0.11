...
$(document).on("click", "#packing-add__button", function() {
    ...
    // delete input data
    $("#packing-date__input").val("").removeClass("complete-input").addClass("no-input");
    $("#packing-start__input").val("").removeClass("complete-input").addClass("no-input");
    $("#packing-end__input").val("").removeClass("complete-input").addClass("no-input");
    // packing work history table
    setPackingHistoryTable();
